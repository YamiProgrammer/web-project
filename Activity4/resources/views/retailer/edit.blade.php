<x-retailer-layout>
    <div class="container mx-auto py-8">
        ...
        <form action="{{ route('retailer.manage-product.update', ['productID' => $product->productID]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="number" id="retailer_price" name="retailer_price" value="{{ old('retailer_price', $retailerProduct->retailer_price ?? $product->productPrice) }}" class="form-input w-full">
            </div>
            ...
            <div class="mb-4">
                ...
                <a href="{{ route('retailer.manage-product') }}" class="ml-4 inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded">Cancel</a>
            </div>
        </form>
    </div>
</x-retailer-layout>
