...
<div class="container p-6">
        <h1 class="pb-6">Supplier Homepage</h1>
                    ...
                    <div class="relative mx-4 mt-4 h-auto overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700">
                        ...
                        <div class="p-6">
                            <div class="mb-2 items-center">
                                ...
                                <p class="block font-sans text-base font-medium leading-relaxed text-blue-gray-900 antialiased">Price: ${{ $product->productPrice }}</p>
                            </div>
                            ...
                            <p class="block font-sans text-base font-medium leading-relaxed text-blue-gray-900 my-2 antialiased">Available Stocks: {{ $product->AvailableStocks }}</p>
